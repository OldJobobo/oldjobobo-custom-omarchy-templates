...
- Added installer documentation for `scripts/install-templates.sh` (recommended and manual install paths).
...
- Added `scripts/install-templates.sh` interactive installer for linking `*.tpl` files into Omarchy overrides.
